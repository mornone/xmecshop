<?php exit;?>a:3:{s:8:"template";a:9:{i:0;s:46:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/goods.dwt";i:1;s:60:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/library/page_header.lbi";i:2;s:62:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/library/ur_here_goods.lbi";i:3;s:62:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/library/goods_gallery.lbi";i:4;s:56:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/library/history.lbi";i:5;s:63:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/library/goods_fittings.lbi";i:6;s:57:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/library/comments.lbi";i:7;s:60:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/library/page_footer.lbi";i:8;s:53:"C:/PHPnow-1.5.6/htdocs/themes/xiaomi/library/help.lbi";}s:7:"expires";i:1450026999;s:8:"maketime";i:1450023399;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>小米水质TDS检测笔_生活周边_小米生活方式_小米官网小米手机、红米手机、小米电视官方正品专卖网站 - Powered by ECShop</title>
...
<script type="text/javascript" src="js/magiczoomplus.js"></script><script type="text/javascript" src="js/easydialog.min.js"></script><script type="text/javascript" src="js/xiaomi_goods.js"></script><div class="breadcrumbs">
	<div class="container">
    	<a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=118">小米生活方式</a> <code>&gt;</code> <a href="category.php?id=123">生活周边</a> <code>&gt;</code> 小米水质TDS检测笔         
    </div>
</div>
...
<div class="goods-detail">
  ...
  <div class="goods-big-pic"> 
  	<a href="images/201507/goods_img/39_P_1437082747827.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 60;zoom-width: 400; zoom-height: 400;" > 
    	<img  alt="小米水质TDS检测笔" src="images/201507/goods_img/39_P_1437082747827.jpg"> 
    </a> 
  </div>
  <div class="goods-small-pic" id="item-thumbs">
  	...
  	<div class="bd">
    	<ul class="cle">
                    ...
                    <li class="current"> 
          	<a href="images/201507/goods_img/39_P_1437082747827.jpg" rel="zoom-id: Zoomer" rev="images/201507/goods_img/39_P_1437082747827.jpg"> 
            	<img alt="小米水质TDS检测笔" src="images/201507/thumb_img/39_thumb_P_1437082747037.jpg"> 
            </a>
          </li>
            ...
            <div class="goods-info-box" id="item-info">
              <dl class="loaded">
              	<dt class="goods-info-head">
                	<dl>
                    	<dt class="goods-name">小米水质TDS检测笔</dt>
                        <dd class="goods-phone-type"><p></p></dd>
                                                <del>专柜价： <em class="cancel">47<em>元</em></em></del>
                                                <dd class="goods-info-head-price clearfix">
                               
                              <span>本店价：</span> <span class="unit"> <b class="nala_price red" id="ECS_SHOPPRICE">39<em>元</em> </b> </span>  
                        ...
                        <dd>
                            ...
                            <ul>
                                                            ...
                                                            <li> <span class="lbl">商品货号</span> <em>ECS000039</em> </li>
                        ...
                        <dd class="goods-info-head-cart">
                          <a href="javascript:addToCart(39)" class="btn  btn-primary goods-add-cart-btn" id="buy_btn"><i class="iconfont"></i>加入购物车</a>
                          <a href="javascript:collect(39)" class=" btn btn-gray  goods-collect-btn " id="fav-btn"><i class="iconfont"></i>喜欢</a> 
                        </dd>
                        <dd class="goods-info-head-userfaq clearfix">
                            <ul>
                                <li class=""><i class="iconfont"></i> 销量 <b>0</b></li>
                                <li class="J_scrollcomment mid"><i class="iconfont"></i> 评价 <b>3</b></li>
                                <li class="J_scrollcomment"><i class="iconfont"></i> 满意度 <b>67%</b></li>
                            </ul>
                        </dd>
                    </dl>
                </dt>
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 39); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 39); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),39); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),39); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
  ...
  <div class="goods-detail-main">
  	<div class="goods-detail-nav" id="goodsDetail">
    	<div class="container">
          <ul class="detail-list">
            ...
            <li><a class="J_scrollHref" href="javascript:void(0);" rel="nofollow">评价晒单(<em>3</em>)</a></li>
          </ul>
        </div>
    </div>
    <div class="product_tabs">
      ...
      <div class="goods-detail-param">
          <div class="container">
          	<ul class="param-list">
            	<li class="goods-img"><img src="images/201507/thumb_img/39_thumb_P_1437082747037.jpg" alt="小米水质TDS检测笔" /></li>
                <li class="goods-tech-spec">
                	<ul>
                        <li>产品名称：小米水质TDS检测笔</li>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:39;}554fcae493e564ee0dc75bdf2ebf94ca        </div>
	  </div>
    </div>
...
<div class="goods-sub-bar" id="goodsSubBar">
	<div class="container">
    	<ul class="detail-list">
          <li> <a class="J_scrollHref" rel="nofollow" href="javascript:void(0);">详情描述</a> </li>
          <li> <a class="J_scrollHref" rel="nofollow" href="javascript:void(0);">规格参数</a> </li>
          <li><a class="J_scrollHref" href="javascript:void(0);" name="pjxqitem" rel="nofollow">评价晒单(<em>3</em>)</a></li>
        </ul>
        <dl class="goods-sub-bar-info clearfix">
        	<dt><img src="images/201507/thumb_img/39_thumb_P_1437082747037.jpg" alt="小米水质TDS检测笔" /></dt>
            <dd>
            	<strong>小米水质TDS检测笔</strong>
                <p><em></em></p>
            </dd>
        </dl>
        <a href="javascript:addToCart(39)" class="btn btn-primary goods-add-cart-btn"><i class="iconfont"></i> 加入购物车</a>
    </div>
</div>
