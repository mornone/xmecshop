...
<div class="container">
	<div class="filter-box">
    	<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_07103600_1450023006');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_07103600_1450023006']):
?>
    	<div class="filter-list-wrap">
        	<dl class="filter-list clearfix filter-list-row-2">
            	<dt><?php echo htmlspecialchars($this->_var['filter_attr_0_07103600_1450023006']['filter_attr_name']); ?>：</dt>
                <?php $_from = $this->_var['filter_attr_0_07103600_1450023006']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
