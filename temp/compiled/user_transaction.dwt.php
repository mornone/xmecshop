...
<div id="wrapper" class="container">	<?php echo $this->fetch('library/ur_here.lbi'); ?> 
     ...
     <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        ...
        <tr>
          <td colspan="2" align="center" bgcolor="#FFFFFF"><input name="act" type="hidden" value="act_edit_password" />
            <input name="submit" type="submit" class="btn btn-primary" style="border:none;" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" />
          </td>
        </tr>
      </table>
    </form>
...
?>
      ...
      <h1><?php echo $this->_var['lang']['add_bonus']; ?></h1>
      <form name="addBouns" action="user.php" method="post" onSubmit="return addBonus()">
        ...
        <?php echo $this->_var['lang']['bonus_number']; ?>
          ...
          <input type="submit" class="btn btn-primary" value="<?php echo $this->_var['lang']['add_bonus']; ?>"  style=" height:26px; line-height:25px; *line-height:22px; width:120px; margin-left:10px; vertical-align:-2px; *vertical-align:-5px;"/>
        </div>
      </form>
    <?php endif; ?>
...
?>
          <tr>
            ...
            <td align="right" bgcolor="#ffffff"><?php echo $this->_var['item']['total_fee']; ?>元</td>
       ...
       <?php echo $this->fetch('library/pages.lbi'); ?>
       <h1><?php echo $this->_var['lang']['merge_order']; ?></h1>
        <script type="text/javascript">
        ...
        <form action="user.php" method="post" name="formOrder" onsubmit="return mergeOrder()">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              ...
              <input type="submit" name="Submit"  class="btn btn-primary" style="border:none;"  value="<?php echo $this->_var['lang']['merge_order']; ?>" /></td>
            </tr>
            <tr>
...
?>
        ...
        <h1><?php echo $this->_var['lang']['goods_list']; ?>
...
?>
        ...
        <h1><?php echo $this->_var['lang']['fee_total']; ?></h1>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
    ...
    <?php endif; ?>
        ...
        <h1><?php echo $this->_var['lang']['consignee_info']; ?></h1>
         <?php if ($this->_var['order']['allow_update_address'] > 0): ?>
           ...
           <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              ...
              <tr>
                <td colspan="4" align="center" bgcolor="#ffffff"><input type="hidden" name="act" value="save_order_address" />
                  ...
                  <input type="submit" class="btn btn-primary" value="<?php echo $this->_var['lang']['update_address']; ?>"  />
                </td>
              </tr>
            </table>
          </form>
          ...
          <?php endif; ?>
        <h1><?php echo $this->_var['lang']['payment']; ?></h1>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                <tr>
                  <td bgcolor="#ffffff">
...
?>
        ...
        <h1><?php echo $this->_var['lang']['other_info']; ?></h1>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          ...
          <tr>
            ...
            <input type="hidden" name="surplus_type" value="1" />
              ...
              <input type="submit" name="submit"  class="btn btn-primary" value="<?php echo $this->_var['lang']['submit_request']; ?>" />
              <input type="reset" name="reset" class="btn btn-primary" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
            </td>
          </tr>
        </table>
        </form>
...
?>
        ...
        <input type="hidden" name="surplus_type" value="0" />
          ...
          <input type="hidden" name="act" value="act_account" />
          <input type="submit" class="btn btn-primary" name="submit" value="<?php echo $this->_var['lang']['submit_request']; ?>" />
          <input type="reset" class="btn btn-primary" name="reset" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
        </td>
      </tr>
          </table>
        </form>
...
?>
                ...
                <tr>
                  ...
                  <td colspan="3" align="center" bgcolor="#ffffff"><?php if ($this->_var['consignee']['consignee'] && $this->_var['consignee']['email']): ?>
                    <input type="submit" name="submit" class="btn btn-primary" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" />
                    <input name="button" type="button" class="btn btn-primary"  onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_address']; ?>'))location.href='user.php?act=drop_consignee&id=<?php echo $this->_var['consignee']['address_id']; ?>'" value="<?php echo $this->_var['lang']['drop']; ?>" />
                    <?php else: ?>
                    <input type="submit" name="submit" class="btn btn-primary"  value="<?php echo $this->_var['lang']['add_address']; ?>"/>
                    <?php endif; ?>
      ...
      <?php endif; ?>
       ...
       <h1><?php echo $this->_var['lang']['transform_points']; ?></h1>
