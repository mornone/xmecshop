<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:59:"D:/wwwroot/ecshop15/wwwroot/mobile/themes/miqinew/goods.dwt";i:1;s:70:"D:/wwwroot/ecshop15/wwwroot/mobile/themes/miqinew/library/comments.lbi";i:2;s:73:"D:/wwwroot/ecshop15/wwwroot/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1446718095;s:8:"maketime";i:1446714495;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>小米平板 64GB_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站 触屏版</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=小米平板 64GB&pic=images/201508/source_img/55_G_1439511725197.jpg"> 分享 </a> </div>
</header>
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201508/thumb_img/55_thumb_G_1439511725721.jpg"  alt="小米平板 64GB" /></a></div>-->
      <ul>
	  <li><a href="javascript:showPic()"><img alt="" src="http://ecshop15.dns300.com/images/201508/source_img/55_G_1439511725197.jpg"/></a></li>
         
         
        <li><a href="javascript:showPic()"><img alt="" src="http://ecshop15.dns300.com/images/201508/thumb_img/55_thumb_P_1439511725800.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://ecshop15.dns300.com/images/201509/thumb_img/55_thumb_P_1441498030464.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://ecshop15.dns300.com/images/201509/thumb_img/55_thumb_P_1441498030567.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://ecshop15.dns300.com/images/201509/thumb_img/55_thumb_P_1441498031389.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://ecshop15.dns300.com/images/201509/thumb_img/55_thumb_P_1441498031661.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(55)" style="display: inline;"></a>
  <div class="title">
    <h1> 小米平板 64GB </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">1499<em>元</em></b>　    <del>1799<em>元</em></del> 
    </li>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <div>请选择<span>尺寸/颜色</span><i></i></div>
    ...
    <form action="javascript:addToCart(55)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields"   style="display: block;">	 
        ...
        <ul class="ul2">
          ...
          <h2>尺寸：</h2>
            <div class="items">
                            				  										...
                            				  										<input type="radio" name="spec_10" value="70" id="spec_value_70" checked onclick="changePrice()" />
                    <label for="spec_value_70">15</label> 
          ...
          <h2>颜色：</h2>
            <div class="items">
                            				                                          ...
                            				                                          <input type="radio" name="spec_11" value="71" id="spec_value_71" checked onclick="changePrice()" />
                    <label for="spec_value_71">蓝-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_11" value="72" id="spec_value_72"  onclick="changePrice()" />
                    <label for="spec_value_72">黄-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_11" value="73" id="spec_value_73"  onclick="changePrice()" />
                    <label for="spec_value_73">黑-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_11" value="74" id="spec_value_74"  onclick="changePrice()" />
                    <label for="spec_value_74">白-<font class="price">缺货</font></label> 
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(55)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(55);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://ecshop15.dns300.com/images/201508/source_img/55_G_1439511725197.jpg"> </div>
            <div id="right">
              <p>小米平板 64GB</p>
...
<section class="s-detail">
  <header>
    <ul style="position: static;" id="detail_nav">
      ...
      <li id="tabs2" onClick="tab(2)" class=""> 评价 <span class="review-count">(12)</span> </li>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:55;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
var end = "结束";
var goodsId = 55;
var now_time = 1446685696;
var imgUrl = "http://ecshop15.dns300.com/images/201508/source_img/55_G_1439511725197.jpg"; //缩略图地址
var lineLink = ""; //分享的链接地址
var descContent = "小米平板 64GB_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //摘要信息
var shareTitle = "小米平板 64GB_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //分享的标题
var appid = ""; 
//分享给朋友
