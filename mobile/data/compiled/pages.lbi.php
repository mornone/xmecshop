      ...
      <div class="pagenav-content">
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="pagenav-cur">
            ...
            <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_28101600_1450023631');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_28101600_1450023631']):
?>    
              <option value="<?php echo $this->_var['item_0_28101600_1450023631']; ?>"><?php echo $this->_var['key']; ?></option>
