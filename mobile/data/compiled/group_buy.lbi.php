...
<div class="item_show_box2 box1 region" style="overflow:hidden">
    ...
    <div id="picScroll2" class="picScroll2">
        ...
        <div class="bd">
            <ul>
                <?php $_from = $this->_var['group_buy_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_53620100_1446694673');$this->_foreach['hot_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hot_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_53620100_1446694673']):
        $this->_foreach['hot_goods']['iteration']++;
?>
                <li><a href="<?php echo $this->_var['goods_0_53620100_1446694673']['url']; ?>"><img src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods_0_53620100_1446694673']['thumb']; ?>" /></a>
                <br/>            
                <span class="price_s"> <?php echo $this->_var['goods_0_53620100_1446694673']['last_price']; ?> </span> <br><?php echo sub_str(htmlspecialchars($this->_var['goods_0_53620100_1446694673']['goods_name']),12); ?>
                </li>
